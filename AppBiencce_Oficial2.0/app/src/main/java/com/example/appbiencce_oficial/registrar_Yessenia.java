    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnbuscar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                buscar("http://192.168.67.82/cursomovil/select.php?id="+id.getText()+"");
            }
        });
        ...
        btninsertar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ejecutar( "http://192.168.67.82/cursomovil/insertar.php");
            }
        });
        ...
        btnactualizar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ejecutarservicio("http://192.168.67.82/cursomovil/actualizar.php");
            }
        });
        ...
        btneliminar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                eliminar("http://192.168.67.82/cursomovil/eliminar.php");
            }
        });
