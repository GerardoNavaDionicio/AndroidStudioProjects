    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pb_consultar_fiesta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                buscar("http://192.168.67.82/cursomovil/selectFies.php?id_fiesta="+edt_fiesta_id.getText()+"");
            }
        });
        pb_registrar_fiesta.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                registrar( "http://192.168.67.82/cursomovil/insertarFies.php");
            }
        });
        pb_actualizar_fiesta.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                actualizar("http://192.168.67.82/cursomovil/actualizarFies.php");
            }
        });
        pb_eliminar_fiesta.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                eliminar("http://192.168.67.82/cursomovil/eliminarFies.php");
            }
        });
    }
