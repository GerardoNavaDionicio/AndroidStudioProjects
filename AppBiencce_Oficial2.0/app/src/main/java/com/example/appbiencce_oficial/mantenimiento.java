    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pb_consultar_mantenimiento.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                buscar("http://192.168.67.82/cursomovil/selectMante.php?id_mantenimiento="+edt_mantenimiento_id.getText()+"");
            }
        });
        pb_registrar_mantenimiento.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                registrar( "http://192.168.67.82/cursomovil/insertarMante.php");
            }
        });
        pb_actualizar_mantenimiento.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                actu("http://192.168.67.82/cursomovil/actualizarMante.php");
            }
        });
        pb_eliminar_mantenimiento.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                eliminar("http://192.168.67.82/cursomovil/eliminarMante.php");
            }
        });
    }
