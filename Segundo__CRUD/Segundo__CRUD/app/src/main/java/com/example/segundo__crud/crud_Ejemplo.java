...
public class crud_Ejemplo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnbuscar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                buscar("http://192.168.7.5/cursomovil/select.php?id="+id.getText()+"");
            }
        });
        ...
        btninsertar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ejecutar( "http://192.168.7.5/cursomovil/insertar.php");
            }
        });
        ...
        btnactualizar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ejecutarservicio("http://192.168.7.5/cursomovil/actualizar.php");
            }
        });
        ...
        btneliminar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                eliminar("http://92.168.7.5/cursomovil/eliminar.php");
            }
        });
