    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pb_consultar_produccion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                buscar("http://192.168.7.5/cursomovil/selectProduc.php?id_produccion="+edt_produccion_id.getText()+"");
            }
        });
        pb_registrar_produccion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                registrar( "http://192.168.7.5/cursomovil/insertarProduc.php");
            }
        });
        pb_actualizar_produccion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                actu("http://192.168.7.5/cursomovil/actualizarProduc.php");
            }
        });
        pb_eliminar_produccion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                eliminar("http://192.168.7.5/cursomovil/eliminarProduc.php");
            }
        });
    }
