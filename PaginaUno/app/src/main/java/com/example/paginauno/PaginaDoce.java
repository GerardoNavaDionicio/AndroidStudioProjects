...
public class PaginaDoce extends AppCompatActivity {
    Button pb,pb1,pb0;
    RadioButton op1,op2,op3,op4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pagina_doce);
    ...
    public void preguntaTrece(View view)
    {
        if (op4.isChecked())
        {
            ...
            Intent trece = new Intent(this,PaginaTrece.class);
            startActivity(trece);
        }
        else
        {
