...
public class PaginaDiecisiete extends AppCompatActivity {
    Button pb,pb1,pb0;
    RadioButton op1,op2,op3,op4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pagina_diecisiete);
    ...
    public void preguntaDieciocho(View view)
    {
        if (op4.isChecked())
        {
            ...
            Intent Dieciocho = new Intent(this,PaginaDieciocho.class);
            startActivity(Dieciocho);
        }
        else
        {
            ImageView i=new ImageView(getApplicationContext());
