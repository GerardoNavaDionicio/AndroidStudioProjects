...
public class PaginaSeis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pagina_seis);
    ...
    public void preguntaSiete(View view)
    {
        if (op4.isChecked())
        {
            ...
            Intent siete = new Intent(this,PaginaSiete.class);
            startActivity(siete);
        }
        else
        {
    ...
    {
        Intent dos = new Intent(this,PaginaSiete.class);
        startActivity(dos);
    }
    public void Volver(View view)
    {
        Intent dos = new Intent(this,PaginaCinco.class);
        startActivity(dos);
    }
}