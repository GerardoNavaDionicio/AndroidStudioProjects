...
public class PaginaQuince extends AppCompatActivity {
    Button pb,pb1,pb0;
    RadioButton op1,op2,op3,op4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pagina_quince);
    ...
    public void preguntaDieciseis(View view)
    {
        if (op4.isChecked())
        {
            ...
            Intent PaginaDiesiceis = new Intent(this,PaginaDiesiceis.class);
            startActivity(PaginaDiesiceis);
        }
        else
        {
            ImageView i=new ImageView(getApplicationContext());
    ...
    {
        Intent dos = new Intent(this,PaginaDiesiceis.class);
        startActivity(dos);
    }
