...
public class PaginaCatorce extends AppCompatActivity {
    Button pb,pb1,pb0;
    RadioButton op1,op2,op3,op4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pagina_catorce);
    ...
    public void preguntaQuince(View view)
    {
        if (op1.isChecked())
        {
            ...
            Intent Quince = new Intent(this,PaginaQuince.class);
    ...
    {
        Intent dos = new Intent(this,PaginaQuince.class);
        startActivity(dos);
    }
    public void Volver(View view)
    {
        Intent dos = new Intent(this,PaginaTrece.class);
        startActivity(dos);
    }
}